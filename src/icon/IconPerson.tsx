//Should create common SVG function to reuse
/**
export default function Icon({
  ...
  return (
    <svg className={classNames('block mx-auto', className)} {...props}>
      <use color={color} fill={fill} height={size} href={`${window.location.origin}/icon.svg#${name}`} width={size} />
    </svg>
  )
}
 */

//BTW: Should add prettier config
